...
dw upgrade --version=0.1.5 # pin to a specific release tag
...
leases, queue, namespace, and downstream budget-group dispatch capacity,
remaining capacity, budget source, and query-task pending capacity.
