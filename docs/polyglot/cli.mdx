...
`VERSION` accepts any published release tag, `prerelease`, or `stable`. Leave
it unset to follow the prerelease channel. Additional environment variables:
