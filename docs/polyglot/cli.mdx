...
SDK, see [CLI and Python parity](/docs/polyglot/cli-python-parity).
...
```bash
curl -fsSL https://durable-workflow.com/install.sh | VERSION=0.1.38 sh
dw --version
```
...
dw upgrade --tag=0.1.38     # pin to a specific release tag
