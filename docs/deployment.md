...
- Docker Hub: `durableworkflow/server:0.2.188`
- GitHub Container Registry: `ghcr.io/durable-workflow/server:0.2.188`
...
```env
DW_SERVER_IMAGE=durableworkflow/server:0.2.188
SERVER_PORT=8080
APP_ENV=production
APP_DEBUG=false
