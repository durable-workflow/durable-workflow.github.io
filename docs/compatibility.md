...
|------|--------|-----|------------|----------|-----------|-------|
| 2026-06-05 | 0.2.360 | 0.1.77 | 0.4.85 | 2.0.0-alpha.200 | 2.0.0-alpha.84 | Public release-audit evidence is aligned with the current verified installable artifact tuple while stable 1.x remains the default docs line. |
