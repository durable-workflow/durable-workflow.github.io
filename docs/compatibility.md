...
|------|--------|-----|------------|----------|----------|-----------|-------|
| 2026-07-12 | 0.2.638 | 0.1.89 | 0.4.98 | 0.1.6 | 2.0.0-alpha.264 | 2.0.0-alpha.130 | Public release-audit evidence is aligned with the current published artifact tuple while stable 1.x remains the default docs line. |
