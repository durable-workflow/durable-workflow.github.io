...
|------|--------|-----|------------|----------|----------|-----------|-------|
| 2026-07-11 | 0.2.633 | 0.1.87 | 0.4.98 | 0.1.3 | 2.0.0-alpha.264 | 2.0.0-alpha.129 | Public release-audit evidence is aligned with the current published artifact tuple while stable 1.x remains the default docs line. |
