...
|------|--------|-----|------------|----------|-----------|-------|
| 2026-06-04 | 0.2.298 | 0.1.77 | 0.4.85 | 2.0.0-alpha.197 | 2.0.0-alpha.83 | Public release-audit evidence is aligned with the current verified installable artifact tuple while stable 1.x remains the default docs line. |
