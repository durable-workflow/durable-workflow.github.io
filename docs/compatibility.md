...
|------|--------|-----|------------|----------|-----------|-------|
| 2026-06-04 | 0.2.276 | 0.1.76 | 0.4.85 | 2.0.0-alpha.195 | 2.0.0-alpha.81 | Public release-audit evidence is aligned with the current verified installable artifact tuple while stable 1.x remains the default docs line. |
