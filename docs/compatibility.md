...
|------|--------|-----|------------|----------|-----------|-------|
| 2026-06-02 | 0.2.253 | 0.1.75 | 0.4.84 | 2.0.0-alpha.192 | 2.0.0-alpha.79 | Platform conformance suite version 20 adds a public worker-versioning evidence shard for published PHP/Python worker protocol client execution, so cross-language build-ID pinning evidence can be recorded without naming runner implementation details. |
