...
|------|--------|-----|------------|----------|-----------|-------|
| 2026-07-10 | 0.2.620 | 0.1.86 | 0.4.98 | 2.0.0-alpha.259 | 2.0.0-alpha.125 | Public release-audit evidence is aligned with the current published artifact tuple while stable 1.x remains the default docs line. |
