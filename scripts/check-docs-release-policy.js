...
function assertBuiltDocsPolicy() {
  ...
  assertIncludes(prereleaseIntro, 'durableworkflow/server:0.2.206', '2.0 introduction page');
  ...
  assertIncludes(prereleaseQuickstart, 'durableworkflow/server:0.2.206', '2.0 quickstart page');
